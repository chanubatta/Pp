...
print("\033[95;1m[\x1b[35;5;50m+\033[97;1m]\x1b[35;5;50m JOIN MY TELEGRAM N_9_N_6")
os.system('espeak -a 300 " Join My telegram, N_9_N_6 By DEMO @N_C_P"')
time.sleep(2)
os.system(f'xdg-open https://t.me/N_9_N_6')
os.system('espeak -a 300 " Join My Channel,my friend i am DEMO"')
...
class login():
	...
	def login_WALA(self):
		...
		print(' [\u001b[36m1\033[1;37m] LOGIN WITH ID PASS   • WORKING ')
